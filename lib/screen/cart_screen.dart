                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              InkWell(
                                                onTap: (){
                                                  setState(() {
                                                    totalPrice += cartInfo.data()['price'];
                 ...
                 children: [
                   ...
                   Row(
                     ...
                     children: [
                       ...
                       Text('${((totalPrice+deliveryFee)*dinnar).floor().toString()} IQD',
                         style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),
                       ),
                     ],
                   ),
                       ...
                       onTap: (){
                         setState(() {
                           ...
                           Future.delayed(Duration(milliseconds: 100),(){
                             ...
                             // FirebaseFirestore.instance.collection('users').doc(user.uid).collection('cart').delete();
